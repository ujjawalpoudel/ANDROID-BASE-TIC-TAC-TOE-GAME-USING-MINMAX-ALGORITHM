...
public class SinglePlayerThirdClass extends Activity
{
    ...
    private AI ai  = null;
    public final static String MESSAGE_KEY_SECOND_CLASS1 ="SinglePlayerSecondClassMessage1";//previous message
    public final static String MESSAGE_KEY_SECOND_CLASS2 ="SinglePlayerSecondClassMessage2";//new message
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.single_player_third_class);
        //Set up a new board and AI and assign the initial variables
        board = new GameBoard();
        ai = new AI(aiMark);
        Intent intent=getIntent();
        String message=intent.getStringExtra(MESSAGE_KEY_SECOND_CLASS2);
        String message1=intent.getStringExtra(MESSAGE_KEY_SECOND_CLASS1);
    ...
    private void announce(boolean endState, String player) {
        ...
        Intent intent=getIntent();
        String message=intent.getStringExtra(MESSAGE_KEY_SECOND_CLASS1);
