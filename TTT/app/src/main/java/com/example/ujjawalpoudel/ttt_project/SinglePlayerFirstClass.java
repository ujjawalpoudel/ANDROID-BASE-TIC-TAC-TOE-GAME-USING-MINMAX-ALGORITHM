...
public class SinglePlayerFirstClass extends Activity
{
    ...
    public void StartFirstClass(View view)
    {
        ...
        if (StartText.equals("START"))
        {
            ...
            {
                Intent intent = new Intent(this, SinglePlayerSecondClass.class);
                intent.putExtra(MESSAGE_KEY_FIRST_CLASS, message);
